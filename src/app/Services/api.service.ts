...
export class ApiService {
  ...
  getAllCategories(): Observable<any> {
    return this.http.get(`${this.baseUrl}Categories/GetCategories?page=1&pageSize=20`);
  }
  ...
  getAllCountries(): Observable<any> {
    return this.http.get(`${this.baseUrl}Countries/GetCountries?page=1&pageSize=20`);
  }
  ...
  UpdateWarehouse(id: number, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}Warehouse/UpdateWarehouse/${id}`, data);
  }
  ...
  AssignWarehouseByProductsAndCategories(data:any): Observable<any> {
    return this.http.post(`${this.baseUrl}Warehouse/AssignWarehouseByProductsAndCategories`, data);

  }


  GetCategoriesByWarehouseId(categoryId: number): Observable<any> {
    return this.http.get(`${this.baseUrl}WarehouseCategory/GetCategoriesByWarehouseId/${categoryId}`);
  }


  DeleteByWarehouseIdAndCtegoryId(warehouseId:number,categoryId:number):Observable<any>{
    return this.http.delete(`${this.baseUrl}WarehouseCategory/DeleteByWarehouseId/${warehouseId}/AndCategoryId/${categoryId}`);
  }



  CreateWarehouseCategory(data: any): Observable<any> {
    return this.http.post(`${this.baseUrl}WarehouseCategory/CreateWarehouseCategory`, data);
  }


  CreateWarehouseProduct(data: any): Observable<any> {
    return this.http.post(`${this.baseUrl}WarehouseProduct/CreateWarehouseProduct`, data);
  }
